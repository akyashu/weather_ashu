...
const toggleSerach = () => searchView.classList.toggle("active");
addEventOnElements(searchTogglers, "click", toggleSerach);
    ...
    if (searchField.value) {
        searchTimeout = setTimeout(() => {
            fetchData(url.geo(searchField.value), function(locations) {
                ...
                `;
                const items = [];
                for (const { name, lat, lon, country, state }
                    of locations) {
                                 ...
                                 <div class="highlight-list">
                                     <div class="card card-sm highlight-card one">
                                         ...
                                         <div class="wrapper">
                                             ...
                                             <ul class="card-list">
                                                 <li class="card-item">${pm2_5.toPrecision(3)}</p>
        ...
        `;
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                tempLi.innerHTML = `
                    ...
                    <img src="./assets/images/weather_icons/${icon}.png" alt="${description}" width="48" height="48" class="weather-icon" loading="lazy" title="${description}" />
                ...
                <div class="card card-sm slider-card">
                <p class="body-3">${module.getHours(dateTimeUnix,timezone)}</p>
                <img src="./assets/images/weather_icons/direction.png" alt="direction" width="48" height="48" class="weather-icon" loading="lazy" style="transform:rotate(${windDirection-180}deg)" />
                <p class="body-3">${parseInt(module.mps_to_kmph(windSpeed))}Km/h</p>
                </div>
            `;
